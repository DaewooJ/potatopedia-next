...
const RAW_VARIETIES = [
  ...
  { name: "Charlotte", origin: "France (1981)", region: "Western Europe", year: "1981", uses: ["Boiling / Salad"], trait: "Premium French waxy variety. Holds shape, prized for salads and Niçoise-style dishes." },
  ...
  { name: "Amandine", origin: "France (1994)", region: "Specialty / Heritage", year: "1994", uses: ["Boiling / Salad", "Specialty"], trait: "French heritage yellow salad variety. Long oblong, holds shape; popular in French gastronomy." },
  ...
  { name: "Stemster", origin: "Denmark (heritage)", region: "Specialty / Heritage", uses: ["All-purpose"], trait: "Danish heritage variety. Long-running Scandinavian commercial cultivar." },
];
