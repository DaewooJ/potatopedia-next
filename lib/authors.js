...
export const POTATOPEDIA_PUBLISHER = {
  ...
  description: "Online knowledge base specializing in potato industry data and analysis. 5,024+ verified data points aggregated from FAOSTAT, USDA, CIP, ICAR-CPRI, KALRO, and other primary sources covering 204 countries and 237 commercial varieties.",
  foundingDate: "2024",
  inLanguage: "en",
...
export const POTATOPEDIA_WEBSITE = {
  ...
  url: "https://www.potatopedia.com",
  name: "Potatopedia",
  description: "Online knowledge base for the global potato industry — 204 countries, 237 commercial varieties, 5,024+ verified data points from primary sources.",
