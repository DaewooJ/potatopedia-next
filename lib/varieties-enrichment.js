  ...
  return [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `For systematic comparison see the <a href=\"/varieties/compare\" style=\"color:#C62828;text-decoration:none\">variety compare tool</a> or <a href=\"/varieties\" style=\"color:#C62828;text-decoration:none\">browse all 244 varieties</a> in our database. Each variety has its own dedicated profile with origin, traits, and uses documented from primary breeder sources.`,
      ],
    },
  ];
}
