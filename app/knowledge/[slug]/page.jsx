...
function TopProducingCountries() {
  ...
  const faqItems = [
    { q: "Which country has the largest production of potatoes?", a: "China is the world's largest potato producer at 94.4 million tonnes annually (FAOSTAT 2023), accounting for roughly 25% of global output. India ranks second at 56.2 million tonnes, followed by Ukraine at 22.5 million tonnes." },
    ...
    { q: "What are the top 5 potato producing countries?", a: "The top 5 are: 1) China (94.4M tonnes), 2) India (56.2M), 3) Ukraine (22.5M), 4) Russia (19.6M), and 5) United States (18.7M). Together they produce over 55% of the world's potatoes (FAOSTAT 2023)." },
  ];
  ...
  return (
    <article>
      ...
      <p style={sP}><Link href="/country/china" style={{ color: "#C62828", fontWeight: 600, textDecoration: "none" }}>China</Link> dominates global potato production at 94.4 million tonnes annually, growing approximately 25% of the world&apos;s potatoes on 4.7 million hectares (FAOSTAT 2023). <Link href="/country/india" style={{ color: "#C62828", fontWeight: 600, textDecoration: "none" }}>India</Link> ranks second at 56.2 million tonnes, with Uttar Pradesh alone producing more potatoes than most entire countries. <Link href="/country/ukraine" style={{ color: "#C62828", fontWeight: 600, textDecoration: "none" }}>Ukraine</Link> is third at 22.5 million tonnes, also holding the world&apos;s highest per-capita consumption at 136 kg/year.</p>
      ...
      <p style={sP}><strong>Asia</strong> leads global potato production at approximately 175.8 million tonnes, accounting for 46% of the world total (FAOSTAT 2023). China (94.4M), India (56.2M), <Link href="/country/bangladesh" style={{ color: "#C62828", textDecoration: "none" }}>Bangladesh</Link> (10.8M), and <Link href="/country/pakistan" style={{ color: "#C62828", textDecoration: "none" }}>Pakistan</Link> (5.9M) are the continent&apos;s major producers.</p>
      <p style={sP}><strong>Europe</strong> follows at 107.2 million tonnes, led by <Link href="/country/ukraine" style={{ color: "#C62828", textDecoration: "none" }}>Ukraine</Link> (22.5M), <Link href="/country/russia" style={{ color: "#C62828", textDecoration: "none" }}>Russia</Link> (19.6M), <Link href="/country/germany" style={{ color: "#C62828", textDecoration: "none" }}>Germany</Link> (11.7M), and <Link href="/country/france" style={{ color: "#C62828", textDecoration: "none" }}>France</Link> (8.8M). European yields are among the world&apos;s highest, with <Link href="/country/belgium" style={{ color: "#C62828", textDecoration: "none" }}>Belgium</Link> averaging 46.0 t/ha.</p>
      <p style={sP}><strong>The Americas</strong> contribute 38.5 million tonnes, with the <Link href="/country/united-states" style={{ color: "#C62828", textDecoration: "none" }}>United States</Link> (18.7M), <Link href="/country/peru" style={{ color: "#C62828", textDecoration: "none" }}>Peru</Link> (5.6M), and <Link href="/country/canada" style={{ color: "#C62828", textDecoration: "none" }}>Canada</Link> (5.3M) as the top producers. <strong>Africa and the Middle East</strong> account for 28.9 million tonnes and are growing fastest, with <Link href="/country/egypt" style={{ color: "#C62828", textDecoration: "none" }}>Egypt</Link> (6.3M) and <Link href="/country/algeria" style={{ color: "#C62828", textDecoration: "none" }}>Algeria</Link> (4.60M, FAOSTAT 2024) as the leading African producers.</p>
...
function PotatoConsumptionPerCapita() {
  ...
  return (
    <article>
      ...
      <p style={sP}>The <Link href="/country/netherlands" style={{ color: "#C62828", textDecoration: "none" }}>Netherlands</Link> produces 7.1 million tonnes but consumes only 78 kg per capita across its small population; the rest feeds its world-leading <Link href="/answers/netherlands-seed-potato-exports" style={{ color: "#C62828", textDecoration: "none" }}>seed potato</Link> and processing export industries. <Link href="/country/egypt" style={{ color: "#C62828", textDecoration: "none" }}>Egypt</Link> produces 6.3 million tonnes but consumes 26 kg per capita, exporting over 1 million tonnes annually. For full production rankings, see <Link href="/knowledge/top-potato-producing-countries" style={{ color: "#C62828", textDecoration: "none" }}>Top Producing Countries</Link>.</p>
...
function WhyPotatoesIllegalInFrance() {
  ...
  return (
    <article>
      ...
      <p style={sP}>Today the potato is the world&apos;s <strong>fourth most important food crop</strong> after rice, wheat, and maize. Global production reached 383 million tonnes in 2023 (FAOSTAT), grown across 160+ countries on every inhabited continent. <Link href="/country/china" style={{ color: "#C62828", fontWeight: 600, textDecoration: "none" }}>China</Link> leads at 94.4 million tonnes, <Link href="/country/india" style={{ color: "#C62828", textDecoration: "none" }}>India</Link> follows at 56.2 million tonnes, and <Link href="/country/ukraine" style={{ color: "#C62828", textDecoration: "none" }}>Ukraine</Link> ranks third at 22.5 million tonnes. France &mdash; the country that rejected potatoes in 1748 &mdash; today produces over 8 million tonnes annually and is one of the largest seed potato exporters in Europe.</p>
    ...
    switch (slug) {
      case "top-potato-producing-countries": {
        const tpcFaq = [
          ...
          { q: "What are the top 5 potato producing countries?", a: "China (94.4M), India (56.2M), Ukraine (22.5M), Russia (19.6M), United States (18.7M) per FAOSTAT 2023." },
        ];
